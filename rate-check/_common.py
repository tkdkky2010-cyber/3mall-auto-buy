...
# ============================================================
# 16개 조합 본품 구성 (TOP 16, 월환산수익 기준)
# ============================================================
COMBOS: list[list[tuple[str, int]]] = [
    [("c", 3), ("h", 1)],     # 1  자음2종3 + 리치1
    [("e", 2), ("h", 1)],     # 2  탄력3종2 + 리치1
    [("e", 1), ("f", 4)],     # 3  탄력3종1 + 윤조에센스4
    [("e", 1), ("h", 2)],     # 4  탄력3종1 + 리치2
    [("c", 2), ("f", 3)],     # 5  자음2종2 + 윤조에센스3
    [("g", 1), ("h", 2)],     # 6  자음생2종1 + 리치2
    [("f", 4), ("g", 1)],     # 7  윤조에센스4 + 자음생2종1
    [("c", 1), ("f", 4)],     # 8  자음2종1 + 윤조에센스4
    [("h", 3)],               # 9  리치3 (정가 810k, 예외)
    [("e", 2), ("f", 2)],     # 10 탄력3종2 + 윤조에센스2
    [("f", 5)],               # 11 윤조에센스5
    [("c", 3), ("f", 2)],     # 12 자음2종3 + 윤조에센스2
    [("g", 2), ("h", 1)],     # 13 자음생2종2 + 리치1
    [("c", 2), ("e", 2)],     # 14 자음2종2 + 탄력3종2
    [("e", 3), ("f", 1)],     # 15 탄력3종3 + 윤조에센스1
    [("c", 1), ("e", 3)],     # 16 자음2종1 + 탄력3종3
]
